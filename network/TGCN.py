...
from my_dataset import TGCN_Dataset


class TGCN_Agent(object):
    ...
    def load_data(self, data_path, start_time, valid_time, end_time, num_workers = 10):
        ...
        dataset_train = TGCN_Dataset(data_path, start_time, valid_time)
        self.train_loader = DataLoader(
            dataset_train, batch_size=self.batch_size, shuffle=True, num_workers = num_workers)
        dataset_test = TGCN_Dataset(data_path, valid_time, end_time)
    ...
    def train(self,
        ...
        for i in range(epoch):
            ...
            for j, (X, y) in enumerate(self.train_loader):
                X = X[0, :self.individual_num, :, :].to(self.device)
                y = y[0, :self.individual_num, :].to(self.device)
