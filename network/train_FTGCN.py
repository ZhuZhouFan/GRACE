...
if __name__ == '__main__':
    ...
    log_dir_ = f'{root_dir}/FTGCN_model/{market_name}_{relation_name}/{args.start_time}_{args.end_time}/hidden_{args.hidden}_lag_{lag_order}_horizon_1_seed_{args.seed}/{tau}'
